...
namespace VOID
{
    ...
    public class VOIDFlightMaster : MonoBehaviour
    {
		 ...
		 * Static Members
		 * */
		private static VOIDFlightMaster _instance;

		public static VOIDFlightMaster Instance
		{
			get
			{
				if (_instance == null)
				{
					Tools.PostDebugMessage ("Instantiating VOIDFlightMaster.");
					_instance = new VOIDFlightMaster();
				}
				return _instance;
			}
		}
